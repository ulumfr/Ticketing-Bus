				...
				for (int x = 1; x == 1;) {
					...
					for (x = 1; x == 1;) {
						...
						if (choice.equals("1")) {
							...
							// available//
							System.out.println("***************************************");
							System.out.println("**   DESTINATION  |  RUPIAH |  SEAT  **");
							System.out.println("***************************************");
						...
						// if CHOICE is "2" proceed to Ticket Booking//
							...
							// inputing of Passenger's Name//
								...
								double fare[] = { 0, 80000, 30000, 15000, 10000, 5000 };
								...
								if (print == 1) {
									...
									System.out.println("RUPIAH PRICE: Rp" + ticketD[z][0]);
							...
							for (x = 1; x == 1;) {
								...
								for (int b = 0; b < z; b++) {
									if (search.equalsIgnoreCase(ticketS[b][0])) {
										...
										System.out.println("RUPIAH PRICE: Rp" + ticketD[b][0]);
										...
										if (ticketS[b][2].equals("x")) {
											...
											for (x = 1; x == 1;) {
												System.out.println("\nPASSENGER'S TOTAL RUPIAH: Rp " + ticketD[b][2]);
							...
							for (int sx = 1; sx <= 3;) {
								...
								for (x = 0; x <= z; x++) {
									if (search.equalsIgnoreCase(ticketS[x][0])) {
										...
										System.out.println("RUPIAH PRICE: Rp" + ticketD[x][0]);
										System.out.println("NO. OF PASSENGERS: " + ticketI[x][0]);
										System.out.println("NO. OF PASSENGERS WITH DISCOUNT: " + ticketI[x][1]);
										System.out.println("TOTAL RUPIAH PRICE: Rp " + ticketD[x][2]);
										if (ticketS[x][2].equals("x")) {
											System.out.println("PAY: Rp " + pay[x]);
											System.out.println("CHANGE: Rp " + change[x]);
